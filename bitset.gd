...
func _init(size_: int = 0, default: bool = false):
	...
	var fullElems = size_ / BITS_PER_INT
	var lastElemBits = size_ % BITS_PER_INT

	var totalElems = fullElems
...
func set_all():
	@warning_ignore("integer_division")
	var fullElems = size / BITS_PER_INT
	var lastElemBits = size % BITS_PER_INT
...
func get_bit(bit_num: int) -> bool:
	...
	@warning_ignore("integer_division")
	var el_num = bit_num / BITS_PER_INT
	var el_bit_num = bit_num % BITS_PER_INT
...
func set_bit(bit_num: int, value: bool = true):
	...
	@warning_ignore("integer_division")
	var el_index = bit_num / BITS_PER_INT
	var bit_index = bit_num % BITS_PER_INT
...
func get_first_set_bit_index(bits: int) -> int:
	...
	var res = (BITS_PER_INT >> 1) - 1
	var step = BITS_PER_INT >> 2
